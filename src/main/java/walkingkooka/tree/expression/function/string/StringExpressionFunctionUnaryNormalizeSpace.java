 ...
 */
final class StringExpressionFunctionUnaryNormalizeSpace<C extends ExpressionFunctionContext> extends StringExpressionFunctionUnary<C> {
    /**
     * Instance getter.
     */
    static <C extends ExpressionFunctionContext> StringExpressionFunctionUnaryNormalizeSpace<C> instance() {
     ...
     * Singleton
     */
    private static final StringExpressionFunctionUnaryNormalizeSpace<?> INSTANCE = new StringExpressionFunctionUnaryNormalizeSpace<>();
