...
public final class StringExpressionFunctionUnaryNormalizeSpaceTest extends StringExpressionFunctionUnaryTestCase<StringExpressionFunctionUnaryNormalizeSpace<ExpressionFunctionContext>> {
    ...
    @Override
    public StringExpressionFunctionUnaryNormalizeSpace<ExpressionFunctionContext> createBiFunction() {
        return StringExpressionFunctionUnaryNormalizeSpace.instance();
    }

    @Override
    public Class<StringExpressionFunctionUnaryNormalizeSpace<ExpressionFunctionContext>> type() {
        return Cast.to(StringExpressionFunctionUnaryNormalizeSpace.class);
    }
}
