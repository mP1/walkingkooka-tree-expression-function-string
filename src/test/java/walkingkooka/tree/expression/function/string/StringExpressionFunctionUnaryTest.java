...
public final class StringExpressionFunctionUnaryTest extends StringExpressionFunctionTestCase<StringExpressionFunctionUnary<ExpressionEvaluationContext>> {
    ...
    private void lowerCaseAndCheck(final String input,
    ...
    private void normalizeSpaceAndCheck(final String input,
                                        final String expected) {
        this.unaryAndCheck(
    ...
    @Test
    public void testProperWithEmpty() {
        this.properAndCheck("");
    }

    @Test
    public void testProperWithSpace() {
        this.properAndCheck(" ");
    }

    @Test
    public void testProperWithAllSpaces() {
        this.properAndCheck("   ");
    }

    @Test
    public void testProperWithAllNumbers() {
        this.properAndCheck("123456");
    }

    @Test
    public void testProperWithAllNumbersAndWhitespaces() {
        this.properAndCheck("123 45\t6");
    }

    @Test
    public void testProperWithAllSymbols() {
        this.properAndCheck("!./");
    }

    @Test
    public void testProperWithSymbolNumbersWhitespace() {
        this.properAndCheck("! 1 2 3");
    }

    @Test
    public void testProperWithLetters() {
        this.properAndCheck(
            "abc",
            "Abc"
        );
    ...
    @Test
    public void testProperWithLetters2() {
        this.properAndCheck(
            "ABC",
            "Abc"
        );
    ...
    @Test
    public void testProperWithLetters3() {
        this.properAndCheck(
            "AbC",
            "Abc"
        );
    ...
    @Test
    public void testProperWithLettersAndNumbers() {
        this.properAndCheck(
            "ABC123",
            "Abc123"
        );
    ...
    @Test
    public void testProperWithLettersWhitespaceLetters() {
        this.properAndCheck(
            "ABC DEF",
            "Abc Def"
        );
    ...
    @Test
    public void testProperWithLettersDashLetters() {
        this.properAndCheck(
            "ABC-DEF",
            "Abc-Def"
        );
    ...
    @Test
    public void testProperWithLettersDashLetters2() {
        this.properAndCheck(
            "ABC-DEF-567-GHI",
            "Abc-Def-567-Ghi"
        );
    ...
    @Test
    public void testProperWithSentence() {
    ...
    private void spaceTrimAndCheck(final String input,
                                   final String expected) {
        this.unaryAndCheck(
    ...
    private void trimAndCheck(final String input,
                              final String expected) {
        this.unaryAndCheck(
    ...
    private void trimLeftAndCheck(final String input,
                                  final String expected) {
        this.unaryAndCheck(
    ...
    private void trimRightAndCheck(final String input,
                                   final String expected) {
        this.unaryAndCheck(
    ...
    private void upperCaseAndCheck(final String input,
                                   final String expected) {
        this.unaryAndCheck(
