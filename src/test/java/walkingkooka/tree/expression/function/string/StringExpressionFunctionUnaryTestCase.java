...
public abstract class StringExpressionFunctionUnaryTestCase<F extends StringExpressionFunctionUnary<ExpressionFunctionContext>> extends StringExpressionFunctionTestCase<F, String> {

    StringExpressionFunctionUnaryTestCase() {
        super();
    }
