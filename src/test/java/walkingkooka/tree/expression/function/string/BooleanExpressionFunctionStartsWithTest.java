...
public final class BooleanExpressionFunctionStartsWithTest extends BooleanExpressionFunctionTestCase<BooleanExpressionFunctionStartsWith<ExpressionFunctionContext>> {
    ...
    @Override
    public BooleanExpressionFunctionStartsWith<ExpressionFunctionContext> createBiFunction() {
        return BooleanExpressionFunctionStartsWith.instance();
    }

    @Override
    public Class<BooleanExpressionFunctionStartsWith<ExpressionFunctionContext>> type() {
        return Cast.to(BooleanExpressionFunctionStartsWith.class);
    }
}
